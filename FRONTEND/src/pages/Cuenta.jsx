...
import { useEditarFormulario } from '../../Hooks/funciones';


function FormularioCuenta() {
  
  const {inputsDeshabilitados, toggleEdita} = useEditarFormulario();
      ...
      <div className="container-fluid m-4" id="form">
        ...
        <div className="row" id="usuarioo">
          <div className="col-lg-6 col-md-6 col-sm-12 mt-4">
            <h1 className="fs-5">Datos Personales <button className="bg-transparent border-0 rounded" id="boton-aper" type="button"  onClick={toggleEdita}>
              <img src={edit} width="20px" alt="editar" />
            </button></h1>
            <div className="m-4">
              <label htmlFor="nombre">Nombre</label>
              <input type="text" name="nombre" id="nombre" className="entrada inp_pedi" disabled= {inputsDeshabilitados}/>
            </div>
            <div className="m-4">
              <label htmlFor="corre_E">Correo Electronico</label>
              <input type="email" name="corre_E" id="corre_E" className="entrada inp_pedi" autoComplete="email" disabled= {inputsDeshabilitados} />
            </div>
            <div className="m-4">
              <label htmlFor="telefono">Telefono</label>
              <input type="text" name="telefono" id="telefono" className="entrada inp_pedi" disabled= {inputsDeshabilitados} />
            </div>
          </div>
          <div className="col-lg-6 col-md-6 col-sm-12 mt-4">
            <div className="m-4">
              <label htmlFor="direccion">Direccion</label>
              <input type="text" name="direccion" id="direccion" className="entrada inp_pedi" disabled= {inputsDeshabilitados} />
            </div>
            <div className="m-4">
              <label htmlFor="tarj">Numero Tarjeta</label>
              <input type="text" name="num_tarj" id="tarj" className="entrada inp_pedi" disabled= {inputsDeshabilitados} maxLength="10" />
            </div>
            <Boton
